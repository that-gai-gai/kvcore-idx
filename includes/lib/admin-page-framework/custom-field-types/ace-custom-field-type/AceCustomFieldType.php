<?php
/**
 * kvCORE_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'kvCORE_AceCustomFieldType' ) ) :
class kvCORE_AceCustomFieldType extends kvCORE_AdminPageFramework_FieldType {
    ...
    protected function getScripts() {
        ...
        return "jQuery( document ).ready( function(){
            ...
            var addAceEditor = function(oTextArea) {
                ...
                }).css('max-width', getWidth( oTextArea ))
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.kvcore-field' ).nextAll().andSelf().each( function( iIndex ) {
    ...
    protected function getStyles() {
        return "/*Ace editor Custom Field Type*/
            ...
            .kvcore-field-ace, .kvcore-field-ace > div {
                width: 100%;
            }
        "  . PHP_EOL;
     }
    ...
    public function getField( $aField ) {
        ...
        return
            $aField['before_label']
            . "<div class='kvcore-input-label-container'>"
