 ...
 * @package     kvCORE_AdminPageFramework
 */

if ( ! class_exists( 'kvCORE_Select2CustomFieldType' ) ) :
/**
 ...
 */
class kvCORE_Select2CustomFieldType extends kvCORE_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.kvcore-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.kvcore-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.kvcore-select-label' )
                .children( 'label' )
                .children( '.kvcore-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set inital values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.kvcore-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.kvcore-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    jQuery().registerkvCORE_AdminPageFrameworkCallbacks( {
        /**
    ...
    protected function getStyles() {
        return "
.kvcore-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.kvcore-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .kvcore-field-select2 > .kvcore-select-label > label > .kvcore-input-container {
    max-width: 84%;
}
