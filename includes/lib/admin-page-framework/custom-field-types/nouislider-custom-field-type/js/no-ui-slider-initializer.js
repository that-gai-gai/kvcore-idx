(function ($) {
    jQuery( document ).ready( function(){
        ...
        var _initializeNoUISliders = function( nodeThis ) {
            ...
            var _oTargetSlider = jQuery( nodeThis ).closest( '.kvcore-field' )
            ...
            initializeNoUISlider(
                jQuery( nodeThis ).closest( '.kvcore-field' )
                    .children( '.no-ui-sliders' )
                    .first().get( 0 )
            );
        ...
        jQuery( 'input[data-type=no_ui_slider][data-interactive=1]' ).on( 'change', function(){
            ...
            var _oTargetSlider    = jQuery( this ).closest( '.kvcore-field' )
                .children( '.no-ui-sliders' )
                .first();
            ...
            function _setEmptyInputValues( nodeInput, aValues ) {
                ...
                jQuery( nodeInput ).closest( '.kvcore-field' ).children( '.kvcore-input-label-container' )
            ...
            function _getInputValuesSanitized( aValues, nodeInput ) {
                ...
                var _aValues = [];
                var _aRange  = jQuery( nodeInput ).closest( '.kvcore-field' ).children( '.no-ui-sliders' )
                    .first()
                    .data( 'range' );
