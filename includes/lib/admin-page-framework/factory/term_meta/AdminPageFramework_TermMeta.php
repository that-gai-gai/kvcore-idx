...
abstract class kvCORE_AdminPageFramework_TermMeta_Router extends kvCORE_AdminPageFramework_TaxonomyField_Controller {
}
abstract class kvCORE_AdminPageFramework_TermMeta_Model extends kvCORE_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new kvCORE_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class kvCORE_AdminPageFramework_TermMeta_View extends kvCORE_AdminPageFramework_TermMeta_Model {
...
abstract class kvCORE_AdminPageFramework_TermMeta_Controller extends kvCORE_AdminPageFramework_TermMeta_View {
}
abstract class kvCORE_AdminPageFramework_TermMeta extends kvCORE_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'kvcore') {
