...
class kvCORE_AdminPageFramework_View__PageRenderer extends kvCORE_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    private function _getContentTop() {
        $_oScreenIcon = new kvCORE_AdminPageFramework_View__PageRenderer__ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new kvCORE_AdminPageFramework_View__PageRenderer__PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop.= $_oPageHeadingTabs->get();
        $_oInPageTabs = new kvCORE_AdminPageFramework_View__PageRenderer__InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _printPageMetaBoxes() {
        $_oPageMetaBoxRenderer = new kvCORE_AdminPageFramework_View__PageMataBoxRenderer();
    ...
    private function _printFormOpeningTag($fEnableForm = true) {
        ...
        echo "<form " . $this->getAttributes(array('method' => 'post', 'enctype' => $this->oFactory->oProp->sFormEncType, 'id' => 'kvcore-form', 'action' => wp_unslash(remove_query_arg('settings-updated', $this->oFactory->oProp->sTargetFormPage)),)) . " >" . PHP_EOL;
