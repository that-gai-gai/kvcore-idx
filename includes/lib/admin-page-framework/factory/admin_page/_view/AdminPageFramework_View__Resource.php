...
class kvCORE_AdminPageFramework_View__Resource extends kvCORE_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new kvCORE_AdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new kvCORE_AdminPageFramework_Format_PageResource_Script($asPageScript);
