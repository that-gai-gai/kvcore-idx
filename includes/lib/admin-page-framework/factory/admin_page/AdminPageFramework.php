...
abstract class kvCORE_AdminPageFramework_Router extends kvCORE_AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'kvcore') {
        $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'kvCORE_AdminPageFramework_Property_' . $this->_sStructureType;
    ...
    public function _replyToLoadComponentsForAjax() {
        ...
        new kvCORE_AdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
...
abstract class kvCORE_AdminPageFramework_Model_Form extends kvCORE_AdminPageFramework_Router {
    public $aFieldErrors;
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'kvcore') {
        ...
        new kvCORE_AdminPageFramework_Model__FormEmailHandler($this);
    ...
    public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        new kvCORE_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
...
abstract class kvCORE_AdminPageFramework_View_Form extends kvCORE_AdminPageFramework_Model_Form {
...
abstract class kvCORE_AdminPageFramework_Controller_Form extends kvCORE_AdminPageFramework_View_Form {
    ...
    public function getValue() {
        ...
        return kvCORE_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
...
abstract class kvCORE_AdminPageFramework_Model_Page extends kvCORE_AdminPageFramework_Controller_Form {
    public function _replyToFinalizeInPageTabs() {
        ...
        foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
            ...
            $_oFormatter = new kvCORE_AdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
...
abstract class kvCORE_AdminPageFramework_View_Page extends kvCORE_AdminPageFramework_Model_Page {
    public function _replyToEnablePageMetaBoxes() {
        new kvCORE_AdminPageFramework_View__PageMetaboxEnabler($this);
    }
    public function _replyToEnqueuePageAssets() {
        new kvCORE_AdminPageFramework_View__Resource($this);
    }
    ...
    protected function _renderPage($sPageSlug, $sTabSlug = null) {
        $_oPageRenderer = new kvCORE_AdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
        $_oPageRenderer->render();
    }
}
abstract class kvCORE_AdminPageFramework_Controller_Page extends kvCORE_AdminPageFramework_View_Page {
...
abstract class kvCORE_AdminPageFramework_Model_Menu extends kvCORE_AdminPageFramework_Controller_Page {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'kvcore') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        new kvCORE_AdminPageFramework_Model_Menu__RegisterMenu($this);
    }
}
abstract class kvCORE_AdminPageFramework_View_Menu extends kvCORE_AdminPageFramework_Model_Menu {
}
abstract class kvCORE_AdminPageFramework_Controller_Menu extends kvCORE_AdminPageFramework_View_Menu {
    ...
    public function addSubMenuLink(array $aSubMenuLink) {
        ...
        $_oFormatter = new kvCORE_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
    ...
    public function addSubMenuPage(array $aSubMenuPage) {
        ...
        $_oFormatter = new kvCORE_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
        $_aSubMenuPage = $_oFormatter->get();
        $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
    }
}
abstract class kvCORE_AdminPageFramework_Model extends kvCORE_AdminPageFramework_Controller_Menu {
}
abstract class kvCORE_AdminPageFramework_View extends kvCORE_AdminPageFramework_Model {
    public function content($sContent) {
        return $sContent;
    }
}
abstract class kvCORE_AdminPageFramework_Controller extends kvCORE_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
        ...
        new kvCORE_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, 'isInThePage'),));
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return kvCORE_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class kvCORE_AdminPageFramework extends kvCORE_AdminPageFramework_Controller {
    protected $_sStructureType = 'admin_page';
    public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'kvcore') {
    ...
    private function _getCallerPath($sCallerPath) {
        ...
        $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? kvCORE_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
