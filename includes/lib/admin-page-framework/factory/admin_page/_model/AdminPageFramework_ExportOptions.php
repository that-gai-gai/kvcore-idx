...
abstract class kvCORE_AdminPageFramework_CustomSubmitFields extends kvCORE_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class kvCORE_AdminPageFramework_ExportOptions extends kvCORE_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo kvCORE_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
