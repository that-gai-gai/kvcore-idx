...
class kvCORE_AdminPageFramework_Property_admin_page extends kvCORE_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'kvcore') {
        ...
        $GLOBALS['akvCORE_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('akvCORE_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['akvCORE_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
