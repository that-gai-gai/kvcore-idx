...
abstract class kvCORE_AdminPageFramework_Model__FormSubmission_Base extends kvCORE_AdminPageFramework_FrameworkUtility {
...
class kvCORE_AdminPageFramework_Model__FormSubmission extends kvCORE_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new kvCORE_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new kvCORE_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
