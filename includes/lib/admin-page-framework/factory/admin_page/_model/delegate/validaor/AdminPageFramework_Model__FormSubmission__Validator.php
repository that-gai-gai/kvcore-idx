...
class kvCORE_AdminPageFramework_Model__FormSubmission__Validator_Base extends kvCORE_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class kvCORE_AdminPageFramework_Model__FormSubmission__Validator extends kvCORE_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('kvCORE_AdminPageFramework_Model__FormSubmission__Validator__Link', 'kvCORE_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'kvCORE_AdminPageFramework_Model__FormSubmission__Validator__Import', 'kvCORE_AdminPageFramework_Model__FormSubmission__Validator__Export', 'kvCORE_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'kvCORE_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'kvCORE_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'kvCORE_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new kvCORE_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
