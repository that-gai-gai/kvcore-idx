...
class kvCORE_AdminPageFramework_Model__FormSubmission__Validator__Import extends kvCORE_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new kvCORE_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
...
class kvCORE_AdminPageFramework_Model__FormSubmission__Validator__Export extends kvCORE_AdminPageFramework_Model__FormSubmission__Validator__Import {
    public $sActionHookPrefix = 'try_validation_after_';
    ...
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new kvCORE_AdminPageFramework_ExportOptions($_POST['__export'], $this->oFactory->oProp->sClassName);
