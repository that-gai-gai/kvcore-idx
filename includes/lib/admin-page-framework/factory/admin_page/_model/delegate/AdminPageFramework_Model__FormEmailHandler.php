...
class kvCORE_AdminPageFramework_Model__FormEmailHandler extends kvCORE_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToSendFormEmail() {
        ...
        $_oEmail = new kvCORE_AdminPageFramework_FormEmail($_aFormEmail['email_options'], $_aFormEmail['input'], $_aFormEmail['section_id']);
        $_bSent = $_oEmail->send();
        exit;
    }
}
