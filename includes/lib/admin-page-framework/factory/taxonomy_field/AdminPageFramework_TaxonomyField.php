...
abstract class kvCORE_AdminPageFramework_TaxonomyField_Router extends kvCORE_AdminPageFramework_Factory {
...
abstract class kvCORE_AdminPageFramework_TaxonomyField_Model extends kvCORE_AdminPageFramework_TaxonomyField_Router {
...
abstract class kvCORE_AdminPageFramework_TaxonomyField_View extends kvCORE_AdminPageFramework_TaxonomyField_Model {
...
abstract class kvCORE_AdminPageFramework_TaxonomyField_Controller extends kvCORE_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class kvCORE_AdminPageFramework_TaxonomyField extends kvCORE_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'kvcore') {
