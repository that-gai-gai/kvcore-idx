...
abstract class kvCORE_AdminPageFramework_PageMetaBox_Router extends kvCORE_AdminPageFramework_MetaBox_View {
...
abstract class kvCORE_AdminPageFramework_PageMetaBox_Model extends kvCORE_AdminPageFramework_PageMetaBox_Router {
...
abstract class kvCORE_AdminPageFramework_PageMetaBox_View extends kvCORE_AdminPageFramework_PageMetaBox_Model {
}
abstract class kvCORE_AdminPageFramework_PageMetaBox_Controller extends kvCORE_AdminPageFramework_PageMetaBox_View {
...
abstract class kvCORE_AdminPageFramework_PageMetaBox extends kvCORE_AdminPageFramework_PageMetaBox_Controller {
    protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'kvcore') {
