...
abstract class kvCORE_AdminPageFramework_Widget_Router extends kvCORE_AdminPageFramework_Factory {
...
abstract class kvCORE_AdminPageFramework_Widget_Model extends kvCORE_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new kvCORE_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class kvCORE_AdminPageFramework_Widget_View extends kvCORE_AdminPageFramework_Widget_Model {
...
abstract class kvCORE_AdminPageFramework_Widget_Controller extends kvCORE_AdminPageFramework_Widget_View {
...
abstract class kvCORE_AdminPageFramework_Widget extends kvCORE_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'kvcore') {
