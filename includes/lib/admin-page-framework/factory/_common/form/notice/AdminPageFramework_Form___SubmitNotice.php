...
class kvCORE_AdminPageFramework_Form___SubmitNotice extends kvCORE_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new kvCORE_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new kvCORE_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}
