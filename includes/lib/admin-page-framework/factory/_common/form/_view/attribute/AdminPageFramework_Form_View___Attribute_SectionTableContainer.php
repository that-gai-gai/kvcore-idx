...
class kvCORE_AdminPageFramework_Form_View___Attribute_SectionTableContainer extends kvCORE_AdminPageFramework_Form_View___Attribute_Base {
    protected function _getAttributes() {
        $_aSectionAttributes = $this->uniteArrays($this->dropElementsByType($this->aArguments['attributes']), array('id' => $this->aArguments['_tag_id'], 'class' => $this->getClassAttribute('kvcore-section', $this->getAOrB($this->aArguments['section_tab_slug'], 'kvcore-tab-content', null), $this->getAOrB($this->aArguments['_is_collapsible'], 'is_subsection_collapsible', null)),));
