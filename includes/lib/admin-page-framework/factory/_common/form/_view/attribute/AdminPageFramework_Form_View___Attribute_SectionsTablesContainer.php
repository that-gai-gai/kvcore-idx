...
class kvCORE_AdminPageFramework_Form_View___Attribute_SectionsTablesContainer extends kvCORE_AdminPageFramework_Form_View___Attribute_Base {
    ...
    private function _getDynamicElementArguments($aSectionset) {
        ...
        $_oSectionNameGenerator = new kvCORE_AdminPageFramework_Form_View___Generate_SectionName($aSectionset, $aSectionset['_caller_object']->aCallbacks['hfSectionName']);
