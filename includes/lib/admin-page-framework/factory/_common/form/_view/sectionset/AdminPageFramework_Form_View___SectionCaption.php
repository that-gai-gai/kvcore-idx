...
class kvCORE_AdminPageFramework_Form_View___SectionCaption extends kvCORE_AdminPageFramework_FrameworkUtility {
    ...
    private function _getCaption(array $aSectionset, $iSectionIndex, $aFieldsets, $aFieldErrors, $aFieldTypeDefinitions, $aCallbacks, $oMsg) {
        if (!$aSectionset['description'] && !$aSectionset['title']) {
            return "<caption class='kvcore-section-caption' style='display:none;'></caption>";
        }
    ...
    private function _getSectionError($aSectionset, $aFieldErrors) {
        ...
        return $_sSectionError ? "<div class='kvcore-error'><span class='section-error'>* " . $_sSectionError . "</span></div>" : '';
    }
    private function _getCaptionTitle($aSectionset, $iSectionIndex, $aFieldsets, $aFieldTypeDefinitions) {
        $_oSectionTitle = new kvCORE_AdminPageFramework_Form_View___SectionTitle(array('title' => $aSectionset['title'], 'tag' => 'h3', 'section_index' => $iSectionIndex, 'sectionset' => $aSectionset,), $aFieldsets, $this->aSavedData, $this->aFieldErrors, $aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
        return "<div " . $this->getAttributes(array('class' => 'kvcore-section-title', 'style' => $this->getAOrB($this->_shouldShowCaptionTitle($aSectionset, $iSectionIndex), '', 'display: none;'),)) . ">" . $_oSectionTitle->get() . "</div>";
    }
    private function _getCaptionDescription($aSectionset, $hfSectionCallback) {
        ...
        $_oSectionDescription = new kvCORE_AdminPageFramework_Form_View___Description($aSectionset['description'], 'kvcore-section-description');
        return "<div class='kvcore-section-description'>" . call_user_func_array($hfSectionCallback, array($_oSectionDescription->get(), $aSectionset)) . "</div>";
    }
