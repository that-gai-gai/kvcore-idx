...
class kvCORE_AdminPageFramework_Form_View___DebugInfo extends kvCORE_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='kvcore-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
