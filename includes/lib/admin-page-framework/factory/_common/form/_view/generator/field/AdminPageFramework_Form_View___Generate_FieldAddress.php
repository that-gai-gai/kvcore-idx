...
abstract class kvCORE_AdminPageFramework_Form_View___Generate_Field_Base extends kvCORE_AdminPageFramework_Form_View___Generate_Section_Base {
...
class kvCORE_AdminPageFramework_Form_View___Generate_FieldName extends kvCORE_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class kvCORE_AdminPageFramework_Form_View___Generate_FlatFieldName extends kvCORE_AdminPageFramework_Form_View___Generate_FieldName {
    public function get() {
...
class kvCORE_AdminPageFramework_Form_View___Generate_FieldAddress extends kvCORE_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public function get() {
