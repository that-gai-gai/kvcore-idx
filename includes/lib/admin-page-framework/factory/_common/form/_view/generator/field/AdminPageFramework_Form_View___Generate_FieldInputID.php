...
class kvCORE_AdminPageFramework_Form_View___Generate_FieldTagID extends kvCORE_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class kvCORE_AdminPageFramework_Form_View___Generate_FieldInputID extends kvCORE_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
