...
class kvCORE_AdminPageFramework_Form_View___Script_SortableField extends kvCORE_AdminPageFramework_Form_View___Script_Base {
    ...
    static public function getScript() {
        return <<<JAVASCRIPTS
(function($) {
    $.fn.enablekvCORE_AdminPageFrameworkSortableFields = function( sFieldsContainerID ) {
...
class kvCORE_AdminPageFramework_Form_View___Script_SortableSection extends kvCORE_AdminPageFramework_Form_View___Script_SortableField {
    static public function getScript() {
        return <<<JAVASCRIPTS
(function($) {
    $.fn.enablekvCORE_AdminPageFrameworkSortableSections = function( sSectionsContainerID ) {
        ...
        var _bIsTabbed      = _oTarget.hasClass( 'kvcore-section-tabs-contents' );
        var _bCollapsible   = 0 < _oTarget.children( '.kvcore-section.is_subsection_collapsible' ).length;

        var _oTarget        = _bIsTabbed
            ? _oTarget.find( 'ul.kvcore-section-tabs' )
            : _oTarget;
        ...
        var _aSortableOptions = { 
                items: _bIsTabbed
                    ? '> li:not( .disabled )'
                    : '> div:not( .disabled, .kvcore-collapsible-toggle-all-button-container )', 
                handle: _bCollapsible
                    ? '.kvcore-section-caption'
                    : false,
                ...
                stop: function(e,ui) {
                    ...
                    jQuery( this ).trigger( 
                        'kvcore_stopped_sorting_sections', 
                ...
                // cancel: '.kvcore-section-description, .kvcore-section-title'
        ...
        if ( ! _bIsTabbed ) {
            ...
            _oSortable.bind( 'sortstop', function() {
                ...
                jQuery( this ).find( 'caption > .kvcore-section-title:not(.kvcore-collapsible-sections-title,.kvcore-collapsible-section-title)' ).first().show();
                jQuery( this ).find( 'caption > .kvcore-section-title:not(.kvcore-collapsible-sections-title,.kvcore-collapsible-section-title)' ).not( ':first' ).hide();
...
jQuery( document ).ready( function() {    
    jQuery( '#{$sContainerTagID}' ).enablekvCORE_AdminPageFrameworkSortableSections( '{$sContainerTagID}' ); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='kvcore-section-sortable-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
