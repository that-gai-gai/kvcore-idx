...
class kvCORE_AdminPageFramework_Form_View___Script_Form extends kvCORE_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removekvCORE_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.kvcore-form-loading' ).remove();
        jQuery( '.kvcore-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.kvcore-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removekvCORE_AdminPageFrameworkLoadingOutputs();
