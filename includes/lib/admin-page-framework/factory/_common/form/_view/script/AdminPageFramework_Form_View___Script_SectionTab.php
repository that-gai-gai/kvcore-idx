...
class kvCORE_AdminPageFramework_Form_View___Script_SectionTab extends kvCORE_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.kvcore-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='kvcore-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
