...
class kvCORE_AdminPageFramework_Form_View___ToolTip extends kvCORE_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return "<a " . $this->_getElementAttributes('container', 'kvcore-form-tooltip') . ">" . $this->_getTipLinkIcon() . "<span " . $this->_getElementAttributes('content', 'kvcore-form-tooltip-content') . ">" . $this->_getTipTitle() . $this->_getDescriptions() . "</span>" . "</a>";
    }
    ...
    private function _getTipTitle() {
        if (isset($this->aArguments['title'])) {
            return "<span " . $this->_getElementAttributes('title', 'kvcore-form-tooltip-title') . ">" . $this->aArguments['title'] . "</span>";
        }
        return '';
    }
    private function _getDescriptions() {
        if (isset($this->aArguments['content'])) {
            return "<span " . $this->_getElementAttributes('description', 'kvcore-form-tooltip-description') . ">" . implode("</span><span " . $this->_getElementAttributes('description', 'kvcore-form-tooltip-description') . ">", $this->getAsArray($this->aArguments['content'])) . "</span>";
        }
        return '';
    }
