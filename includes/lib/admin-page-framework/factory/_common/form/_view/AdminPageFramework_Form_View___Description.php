...
class kvCORE_AdminPageFramework_Form_View___Description extends kvCORE_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'kvcore-form-element-description';
