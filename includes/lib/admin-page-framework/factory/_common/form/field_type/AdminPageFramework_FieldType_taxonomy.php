...
class kvCORE_AdminPageFramework_FieldType_taxonomy extends kvCORE_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new kvCORE_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enablekvCORE_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enablekvCORE_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerkvCORE_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Initialize
            enablekvCORE_AdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".kvcore-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.kvcore-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.kvcore-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.kvcore-field .taxonomy-checklist ul ul {margin-left: 1em;}.kvcore-field .taxonomy-checklist-label {white-space: nowrap; }.kvcore-field .tab-box-container.categorydiv {max-height: none;}.kvcore-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.kvcore-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.kvcore-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.kvcore-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.kvcore-field .tab-box-tabs li a { color: #333; text-decoration: none; }.kvcore-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.kvcore-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.kvcore-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.kvcore-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.kvcore-field .tab-box-content:target, .kvcore-field .tab-box-content:target, .kvcore-field .tab-box-content:target { display: block; }.kvcore-field .tab-box-content .select_all_button_container, .kvcore-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.kvcore-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
