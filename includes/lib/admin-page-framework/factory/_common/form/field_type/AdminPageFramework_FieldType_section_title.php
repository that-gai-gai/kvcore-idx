...
class kvCORE_AdminPageFramework_FieldType_section_title extends kvCORE_AdminPageFramework_FieldType_text {
    ...
    protected function getStyles() {
        return ".kvcore-section-tab .kvcore-field-section_title {padding: 0.5em;} .kvcore-section-tab .kvcore-field-section_title .kvcore-input-label-string { vertical-align: middle; margin-left: 0.2em;}.kvcore-section-tab .kvcore-fields {display: inline-block;} .kvcore-field.kvcore-field-section_title {float: none;} .kvcore-field.kvcore-field-section_title input {background-color: #fff;color: #333;border-color: #ddd;box-shadow: inset 0 1px 2px rgba(0,0,0,.07);border-width: 1px;border-style: solid;outline: 0;box-sizing: border-box;vertical-align: middle;}";
    }
