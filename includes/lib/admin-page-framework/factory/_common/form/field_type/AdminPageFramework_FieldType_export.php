...
class kvCORE_AdminPageFramework_FieldType_submit extends kvCORE_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".kvcore-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'kvcore-input-label-container' . ' kvcore-input-button-container' . ' kvcore-input-container',);
    }
...
class kvCORE_AdminPageFramework_FieldType_export extends kvCORE_AdminPageFramework_FieldType_submit {
