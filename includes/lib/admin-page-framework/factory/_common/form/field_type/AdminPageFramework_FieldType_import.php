...
class kvCORE_AdminPageFramework_FieldType_import extends kvCORE_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".kvcore-field-import input {margin-right: 0.5em;}.kvcore-field-import label,.form-table td fieldset.kvcore-fieldset .kvcore-field-import label { display: inline; }";
    }
