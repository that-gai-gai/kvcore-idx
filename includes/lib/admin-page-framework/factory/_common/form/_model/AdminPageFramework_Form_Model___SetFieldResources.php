...
class kvCORE_AdminPageFramework_Form_Model___SetFieldResources extends kvCORE_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new kvCORE_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('kvCORE_AdminPageFramework_Form_View___CSS_Form', 'kvCORE_AdminPageFramework_Form_View___CSS_Field', 'kvCORE_AdminPageFramework_Form_View___CSS_Section', 'kvCORE_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'kvCORE_AdminPageFramework_Form_View___CSS_FieldError', 'kvCORE_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('kvCORE_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new kvCORE_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new kvCORE_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
