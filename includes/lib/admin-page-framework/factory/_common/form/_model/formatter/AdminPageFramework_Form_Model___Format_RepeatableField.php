...
class kvCORE_AdminPageFramework_Form_Model___Format_RepeatableSection extends kvCORE_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : kvCORE_AdminPageFramework_Message::getInstance();
    }
    public function get() {
...
class kvCORE_AdminPageFramework_Form_Model___Format_RepeatableField extends kvCORE_AdminPageFramework_Form_Model___Format_RepeatableSection {
    protected function _getDefaultMessage() {
