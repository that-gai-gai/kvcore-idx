...
class kvCORE_AdminPageFramework_WPUtility_URL extends kvCORE_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(kvCORE_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(kvCORE_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = kvCORE_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class kvCORE_AdminPageFramework_WPUtility_HTML extends kvCORE_AdminPageFramework_WPUtility_URL {
...
class kvCORE_AdminPageFramework_WPUtility_Page extends kvCORE_AdminPageFramework_WPUtility_HTML {
...
class kvCORE_AdminPageFramework_WPUtility_Hook extends kvCORE_AdminPageFramework_WPUtility_Page {
...
class kvCORE_AdminPageFramework_WPUtility_File extends kvCORE_AdminPageFramework_WPUtility_Hook {
...
class kvCORE_AdminPageFramework_WPUtility_Option extends kvCORE_AdminPageFramework_WPUtility_File {
...
class kvCORE_AdminPageFramework_WPUtility_Meta extends kvCORE_AdminPageFramework_WPUtility_Option {
...
class kvCORE_AdminPageFramework_WPUtility_SiteInformation extends kvCORE_AdminPageFramework_WPUtility_Meta {
...
class kvCORE_AdminPageFramework_WPUtility_SystemInformation extends kvCORE_AdminPageFramework_WPUtility_SiteInformation {
...
class kvCORE_AdminPageFramework_WPUtility extends kvCORE_AdminPageFramework_WPUtility_SystemInformation {
