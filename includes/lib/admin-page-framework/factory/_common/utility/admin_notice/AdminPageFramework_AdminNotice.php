...
class kvCORE_AdminPageFramework_AdminNotice extends kvCORE_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'kvcore-settings-notice-message', 'kvcore-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new kvCORE_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
