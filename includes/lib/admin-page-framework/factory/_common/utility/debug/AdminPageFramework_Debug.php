...
class kvCORE_AdminPageFramework_Debug_Base extends kvCORE_AdminPageFramework_FrameworkUtility {
...
class kvCORE_AdminPageFramework_Debug_Log extends kvCORE_AdminPageFramework_Debug_Base {
...
class kvCORE_AdminPageFramework_Debug extends kvCORE_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('kvCORE_AdminPageFramework_Debug::' . __FUNCTION__, 'kvCORE_AdminPageFramework_Debug::dump()');
        kvCORE_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('kvCORE_AdminPageFramework_Debug::' . __FUNCTION__, 'kvCORE_AdminPageFramework_Debug::get()');
        return kvCORE_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('kvCORE_AdminPageFramework_Debug::' . __FUNCTION__, 'kvCORE_AdminPageFramework_Debug::log()');
        kvCORE_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('kvCORE_AdminPageFramework_Debug::' . __FUNCTION__);
