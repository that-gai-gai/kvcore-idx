...
abstract class kvCORE_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'kvCORE_AdminPageFramework_Form_', 'oPageLoadInfo' => 'kvCORE_AdminPageFramework_PageLoadInfo_', 'oResource' => 'kvCORE_AdminPageFramework_Resource_', 'oHelpPane' => 'kvCORE_AdminPageFramework_HelpPane_', 'oLink' => 'kvCORE_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'kvCORE_AdminPageFramework_Debug', 'oUtil' => 'kvCORE_AdminPageFramework_FrameworkUtility', 'oMsg' => 'kvCORE_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(kvCORE_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return kvCORE_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class kvCORE_AdminPageFramework_Factory_Model extends kvCORE_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class kvCORE_AdminPageFramework_Factory_View extends kvCORE_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new kvCORE_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class kvCORE_AdminPageFramework_Factory_Controller extends kvCORE_AdminPageFramework_Factory_View {
...
abstract class kvCORE_AdminPageFramework_Factory extends kvCORE_AdminPageFramework_Factory_Controller {
}
