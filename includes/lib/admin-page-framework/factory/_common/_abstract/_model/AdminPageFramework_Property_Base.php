...
abstract class kvCORE_AdminPageFramework_Property_Base extends kvCORE_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'kvcore' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['akvCORE_AdminPageFramework'])) {
            $GLOBALS['akvCORE_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => kvCORE_AdminPageFramework_Registry::NAME, 'sURI' => kvCORE_AdminPageFramework_Registry::URI, 'sScriptName' => kvCORE_AdminPageFramework_Registry::NAME, 'sLibraryName' => kvCORE_AdminPageFramework_Registry::NAME, 'sLibraryURI' => kvCORE_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => kvCORE_AdminPageFramework_Registry::getVersion(), 'sDescription' => kvCORE_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => kvCORE_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => kvCORE_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => kvCORE_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => kvCORE_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new kvCORE_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
