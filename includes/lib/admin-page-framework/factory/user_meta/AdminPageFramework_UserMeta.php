...
abstract class kvCORE_AdminPageFramework_UserMeta_Router extends kvCORE_AdminPageFramework_Factory {
...
abstract class kvCORE_AdminPageFramework_UserMeta_Model extends kvCORE_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new kvCORE_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class kvCORE_AdminPageFramework_UserMeta_View extends kvCORE_AdminPageFramework_UserMeta_Model {
...
abstract class kvCORE_AdminPageFramework_UserMeta_Controller extends kvCORE_AdminPageFramework_UserMeta_View {
...
abstract class kvCORE_AdminPageFramework_UserMeta extends kvCORE_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'kvcore') {
