...
class kvCORE_AdminPageFramework_Property_post_meta_box extends kvCORE_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'kvcore', $sStructureType = 'post_meta_box') {
