...
abstract class kvCORE_AdminPageFramework_MetaBox_Router extends kvCORE_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'kvcore') {
...
abstract class kvCORE_AdminPageFramework_MetaBox_Model extends kvCORE_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'kvcore') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new kvCORE_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class kvCORE_AdminPageFramework_MetaBox_View extends kvCORE_AdminPageFramework_MetaBox_Model {
...
abstract class kvCORE_AdminPageFramework_MetaBox_Controller extends kvCORE_AdminPageFramework_MetaBox_View {
...
abstract class kvCORE_AdminPageFramework_MetaBox extends kvCORE_AdminPageFramework_MetaBox_Controller {
