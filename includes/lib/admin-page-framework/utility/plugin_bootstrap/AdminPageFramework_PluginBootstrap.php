...
abstract class kvCORE_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('kvCORE_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new kvCORE_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
